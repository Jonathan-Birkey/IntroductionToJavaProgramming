 ...
 * @created : 11Dec2021
 *     <p>Exercise 3.9 (Business: check ISBN-10) An ISBN-10 (International Standard Book Number)
 *     consists of 10 digits: d_1 d_2 d_3 d_4 d_5 d_6 d_7 d_8 d_9 d_10. The last digit, d_10, is a
 *     checksum, which is calculated from the other 9 digits using the following formula: (d_1 * 1 +
 *     d_2 * 2 + d_3 * 3 + d_4 * 4 + d_5 * 5 + d_6 * 6 + d_7 * 7 + d_8 * 8 + d_9 * 9) % 11 If the
...
public class Exercise09 {
  public static void main(String[] args) {
    ...
    else System.out.printf("%d%d%d%d%d%d%d%d%d%d\n", d1, d2, d3, d4, d5, d6, d7, d8, d9, checksum);
  }
}
