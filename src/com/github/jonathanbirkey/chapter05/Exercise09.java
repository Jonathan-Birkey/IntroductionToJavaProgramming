 ...
 * @created : 24Dec2021
 *     <p>Exercise 5.9 (Find the two highest scores) Write a program that prompts the user to enter
 *     the number of students and each student’s name and score, and finally displays the student
 *     with the highest score and the student with the second-highest score. Use the next() method
 *     in the Scanner class to read a name rather than using the nextLine() method. Assume that the
...
public class Exercise09 {
  public static void main(String[] args) {
    ...
    System.out.printf(
        "The student with the highest score was %s, with a score of %.2f\n"
