 ...
 * @created : 07Dec2021
 *     <p>Exercise 1.10 (Average speed in miles) Assume that a runner runs 14 kilometers in 45
...
public class Exercise10 {
  public static void main(String[] args) {
    double averageKPH = 14 / ((45.0 * 60.0 + 30.0) / (60.0 * 60.0));
    double averageMPH = averageKPH / 1.6;
    System.out.printf("%f\n", averageMPH);
  }
}
