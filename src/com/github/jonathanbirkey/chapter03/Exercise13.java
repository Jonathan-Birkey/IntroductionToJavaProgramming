 ...
 * @created : 12Dec2021
 *     <p>Exercise 3.13 (Financial application: compute taxes) Listing 3.5, ComputeTax.java, gives
 *     the source code to compute taxes for single filers. Complete this program to compute taxes
  ...
  public static void main(String[] args) {
    ...
    if (status == 0) { // Compute tax for single filers
      if (income <= 8350) tax = income * 0.10;
        ...
        tax =
            8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (income - 82250) * 0.28;
      ...
      if (income <= 8350) tax = income * 0.10;
        ...
        tax =
            8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (income - 68525) * 0.28;
      ...
      if (income <= 11950) tax = income * 0.10;
        ...
        tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (income - 67900) * 0.25;
